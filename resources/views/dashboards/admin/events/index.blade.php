    ...
    <div class="flex items-center lg:flex-row justify-between gap-4 flex-col sm:gap-4 mb-[20px]">
        ...
        <div class="flex items-center w-full lg:w-fit justify-between gap-3">
            <div class="relative border h-full w-full flex items-center justify-between p-2">
                <input type="text" name="search" placeholder="Tìm kiếm sự kiện" class="outline-none border-none p-0 rounded-sm min-w-[400px] min-h-[24px]">
    ...
    <div class="w-full flex items-center justify-between flex-col gap-3 lg:flex-row">
        <div class="flex items-center w-full lg:w-fit justify-start gap-3 flex-col lg:flex-col xl:flex-row">
            <div class="relative border lg:w-fit flex items-center h-full justify-start p-2 text-gray-400 w-full">
                ...
                <input type="date" name="filter_date_start" id="filter_date_start" class="border-none outline-none p-0 flex-1 lg:w-fit">
            </div>
            <div class="relative w-full lg:w-fit border flex items-center h-full justify-start p-2 text-gray-400">
                ...
                <input type="date" name="filter_date_end" id="filter_date_end" class="border-none p-0 flex-1 outline-none lg:w-fit">
            </div>
            ...
            <button class="h-full p-2 bg-[var(--dark-bg)] w-full xl:w-fit text-white border-[var(--dark-bg)] rounded-sm btn_filter">
                Lọc sự kiện
            </button>
        </div>
        <div class="flex items-center justify-center gap-3 w-full lg:w-fit flex-col xl:flex-row">
            @can('create event')
            <a href="{{ route('events.create') }}" class="block p-2 bg-[var(--dark-bg)] text-white rounded-sm lg:ml-auto xl:w-fit w-full text-center">
                Tạo sự kiện mới
            </a>
            <button class="btn_export_list block p-2 bg-[var(--dark-bg)] text-white rounded-sm lg:ml-auto xl:w-fit w-full text-center">
                Xuất danh sách hiện tại
            </button>

            <button class="btn_export_all block p-2 bg-[var(--dark-bg)] text-white rounded-sm lg:ml-auto xl:w-fit w-full text-center">
                Xuất tất cả sự kiện
            </button>
            @endcan
