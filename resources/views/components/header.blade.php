<header class="shadow-md fixed top-0 left-0 right-0" id="navbar">
    <nav class="navbar flex justify-between items-center w-[92%] mx-auto">
        ...
        <div class="nav-links duration-500 md:static absolute bg-white md:min-h-fit min-h-[60vh] right-0 top-0 md:w-auto w-full flex flex-col items-start px-5 md:hidden gap-5"
            id="sidebar">
