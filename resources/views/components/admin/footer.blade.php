<footer class="bg-[var(--dark-bg)] text-white rounded-tl-3xl rounded-tr-3xl">
    <div class="container mx-auto py-8 px-4">
        <div class="flex flex-wrap">
            ...
            <div class="w-full md:w-1/3 mb-6 text-right">
                ...
                <ul class="mt-2">
                    <li><span class="font-bold">Địa chỉ: </span>53 Võ Văn Ngân, Phường Linh Chiểu, TP. Thủ Đức, TP. HCM</li>
